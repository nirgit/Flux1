...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.force &amp;&amp; !fsUtil.isStale(source, target)) {
<span class="cstat-no" title="statement not covered" >        context.info('target file ' + chalk.cyan(target) + ' is up to date, skipping');</span>
...
<span class="cstat-no" title="statement not covered" >        fs.writeFileSync(target, js);</span>
    }
}
&nbsp;
module.exports = {
