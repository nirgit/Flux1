...
<html lang="en">
<head>
    <title>Code coverage report for src/context.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/context.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; context.js</div>
</div>
<div class="body">
...
var context = {
    ...
    info: <span class="fstat-no" title="function not covered" >function (msg, file, line, column) {</span>
<span class="cstat-no" title="statement not covered" >        context.issue(MESSAGE_LEVEL.INFO, msg, file, line, column);</span>
    },
    warn: <span class="fstat-no" title="function not covered" >function (msg, file, line, column) {</span>
<span class="cstat-no" title="statement not covered" >        context.issue(MESSAGE_LEVEL.WARN, msg, file, line, column);</span>
    },
    ...
    issue: function (level, msg, file, line, column, index) {
        context.messages.push({level: level, msg: msg, file: file || null, line: line || <span class="branch-1 cbranch-no" title="branch not covered" >-1,</span> column: column || <span class="branch-1 cbranch-no" title="branch not covered" >-1,</span> index: index || -1});
    },
...
&nbsp;
module.exports = context;</pre></td></tr>
</table></pre>
