...
<html lang="en">
<head>
    <title>Code coverage report for src/stringUtils.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/stringUtils.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; stringUtils.js</div>
</div>
<div class="body">
...
function addIfNotThere(array, obj) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!_.contains(array, obj)) {
        array.push(obj);
    }
}
&nbsp;
